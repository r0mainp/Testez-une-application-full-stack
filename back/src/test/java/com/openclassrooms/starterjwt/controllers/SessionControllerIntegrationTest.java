...
public class SessionControllerIntegrationTest {
    ...
    public void setUp() {
        ...
        session.setTeacher(null);  // Set to a proper Teacher instance if needed
        session.setUsers(null);    // Set to a proper list of User instances if needed
        ...
        sessionDto.setTeacher_id(null);  // Set to a proper teacher ID if needed
        sessionDto.setUsers(null);       // Set to a proper list of user IDs if needed
    ...
    public void testFindById() throws Exception {
        ...
        mockMvc.perform(get("/api/session/1")
                ...
                .andExpect(jsonPath("$.teacher_id").doesNotExist())
